...
function create () {
  ...
  //   this,
  //   { x: centerX - padding * 3.5, y: padding * 3 }, 
  //   'right'
  // );
  playerOneScore = new Score(
    this,
    { x: centerX - 270, y: padding * 3 }, 
    'right',
    54321
  );
  playerOneScore.create();

  playerTwoScore = new Score(
    this,
    { x: centerX + padding, y: padding * 3 }, 
    'left',
    67890
  );
  playerTwoScore.create();
  ...
  this.physics.add.collider(ball.rect, court.right, playerTwoScores, null, this);
  this.physics.add.collider(ball.rect, court.left, playerOneScores, null, this);
}
...
function playerTwoScores(_ball, wall) {
  playerTwoScore.inc();
  ball.reset()
}

function playerOneScores(_ball, wall) {
  playerOneScore.inc();
  ball.reset()
}
